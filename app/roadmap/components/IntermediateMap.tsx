...
const IntermediateMap = () => {
  ...
  const IntermediateRoadmap = useAtomValue(roadmapDataAtom)[0]?.learningPath?.Intermediate ?? null;
  ...
  console.log("IntermediateRoadmap", IntermediateRoadmap)
    ...
    <div className="min-h-screen pt-20 pb-12 animate-fade-in">
      <div className="container max-w-4xl mx-auto px-4">
        ...
        <div className="mb-10 pl-4">
          {IntermediateRoadmap?.steps && IntermediateRoadmap.steps.length > 0 ? (
            IntermediateRoadmap.steps.map((step: any, index: number) => (
              <RoadmapStep
                key={index}
                step={index + 1}
                title={step?.title ?? ""}
              ...
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <DialogDescription className="mt-1">
                    Step {selectedStep.step} of {IntermediateRoadmap.steps.length}
                  </DialogDescription>
                </div>
